...
#[allow(deprecated)]
use bevy::prelude::{
    warn, Bundle, Changed, Component, GlobalTransform, Query, SpatialBundle, Update, With,
};
...
fn set_spatial_audio_sink_pos(
    ...
    for (spatial_audio_sink, global_transform) in spatial_audio_sinks.iter_mut() {
        ...
        let emitter_position = spatial_audio_listener_translation - spatial_audio_sink_translation;
        spatial_audio_sink
            .sink
